  ...
  <div class="card bg-dark border-0 mb-3">
    <div class="card-body">
      <div class="mb-3 d-flex align-items-center justify-content-between">
        ...
        <button
          :class="['btn btn-sm', devices.length ? 'btn-secondary' : 'btn-primary']"
          @click="onClickPair"
        >
          <i class="bi bi-plus" />
        </button>
          ...
          >
            ...
            <div>
              ...
              <p
                ...
                v-if="device.status & PairedDeviceStatusMask.LOCAL_DEVICE"
              >
                This device
              </p>
              <p
                class="text-secondary small mb-0"
                v-else-if="device.status & PairedDeviceStatusMask.CONNECTED"
              >
                Connected
              </p>
